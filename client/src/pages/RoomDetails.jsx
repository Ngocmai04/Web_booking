...
const RoomDetails = () => {
  const { id } = useParams();
  const { facilityIcons, rooms, getToken, axios, navigate, user } =
    useAppContext(); // ✅ Thêm user từ context
    ...
    try {
      ...
      if (data.success) {
        ...
        if (data.ratings.length > 0) {
          const totals = data.ratings.reduce(
            (acc, review) => ({
    ...
    try {
      ...
      if (existingReview) {
        ...
        const { data } = await axios.put(
          `/api/ratings/${existingReview._id}`,
          payload,
          {
      ...
      <div className="flex items-center gap-3">
        ...
        <input
          ...
          onChange={(e) => {
            ...
            if (val >= 0 && val <= 5) onChange(val);
          }}
          className="w-16 px-2 py-1 border-2 border-gray-300 rounded-lg text-center font-bold focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 outline-none"
        />
      </div>
    </div>
  );
  ...
  return (
    <>
      ...
      {showReviewsSidebar && (
        <div
          className="fixed inset-0 bg-black/60 z-[9999] flex justify-end"
              ...
              {loading ? (
                ...
                reviews.map((review) => {
                  ...
                  return (
                    <div
                      key={review._id}
                      className="bg-white p-6 rounded-2xl border-3 border-red-200 shadow-lg hover:shadow-2xl transition-all"
                    >
            ...
            <form onSubmit={handleSubmitReview} className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-red-100 to-red-200 p-6 rounded-2xl border-3 border-red-400">
                <StarRatingInput
                  ...
                  onChange={(val) =>
                    setReviewData({ ...reviewData, staffRating: val })
                  }
                  label="👥 Staff Rating"
                  color="red"
                />
              ...
              <div className="bg-gradient-to-r from-green-100 to-green-200 p-6 rounded-2xl border-3 border-green-400">
                <StarRatingInput
                  ...
                  onChange={(val) =>
                    setReviewData({ ...reviewData, serviceRating: val })
                  }
              ...
              <div className="bg-gradient-to-r from-blue-100 to-blue-200 p-6 rounded-2xl border-3 border-blue-400">
                <StarRatingInput
                  ...
                  onChange={(val) =>
                    setReviewData({ ...reviewData, cleanlinessRating: val })
                  }
      ...
      {showAllImages && (
        ...
        >
          <div
            className="max-w-6xl w-full max-h-[90vh] overflow-y-auto bg-gradient-to-br from-red-900 to-green-900 rounded-3xl p-6 border-4 border-yellow-400"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex justify-between items-center mb-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {room.images.map((image, index) => (
                <img
                  ...
                  src={image}
                  alt={`Room ${index + 1}`}
                  className="w-full h-64 object-cover rounded-xl border-4 border-yellow-400/60 hover:border-green-400 transition-all cursor-pointer hover:scale-105"
                />
              ))}
            </div>
          </div>
      ...
      {showContactModal && (
        ...
        >
          <div
            className="max-w-xl w-full bg-gradient-to-br from-white via-green-50 to-red-50 rounded-3xl p-8 border-4 border-yellow-400 shadow-2xl"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-3xl font-bold bg-gradient-to-r from-red-600 to-green-600 bg-clip-text text-transparent flex items-center gap-2">
            ...
            <div className="space-y-6">
              {/* Host Info */}
              <div className="flex items-center gap-4 p-4 bg-white rounded-2xl border-2 border-green-300">
                <img
              ...
              {/* Quick Contact Options - Đã sửa: Thêm thẻ <a> */}
              <div className="grid grid-cols-2 gap-3">
                <a
                  href={`tel:${room.hotel.contact}`}
                  className="flex items-center justify-center gap-2 p-4 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-2xl font-bold hover:scale-105 transition-all shadow-lg"
                >
                  📞 Call Now
                </a>

                <a
                  href={`mailto:${room.hotel.contact}`}
                  className="flex items-center justify-center gap-2 p-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-2xl font-bold hover:scale-105 transition-all shadow-lg"
                >
                  📧 Email
                </a>
              </div>
              ...
              >
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Hi! I'm interested in booking your property..."
                    rows="4"
                    className="w-full rounded-2xl border-3 border-green-300 px-4 py-3 outline-none focus:border-red-500 focus:ring-4 focus:ring-red-200 transition-all shadow-md resize-none"
                    required
                  />
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-red-600 via-green-600 to-red-600 hover:from-red-700 hover:via-green-700 hover:to-red-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-black rounded-2xl px-8 py-4 text-lg shadow-2xl hover:shadow-red-500/50 border-4 border-yellow-400 transition-all hover:scale-105 active:scale-95"
                >
                  Send Message
                </button>
              </form>

              {/* WhatsApp Option - Đã sửa: Thêm thẻ <a> */}
              <a
                href={`https://wa.me/${room.hotel.contact.replace(
                  /[^0-9]/g,
                  ""
                )}?text=Hi! I'm interested in booking ${room.roomType} at ${
                  room.hotel.name
                }`}
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 p-4 bg-gradient-to-r from-green-400 to-green-500 text-white rounded-2xl font-bold hover:scale-105 transition-all shadow-lg border-2 border-green-600"
              >
                WhatsApp
              </a>
            </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
              ...
              <div className="flex items-center gap-4">
                {room.discount > 0 && (
                  <div className="relative">
                    ...
                    <div className="relative bg-gradient-to-br from-yellow-400 to-yellow-500 px-6 py-4 rounded-2xl shadow-2xl border-4 border-red-600">
                      <p className="text-red-700 font-black text-3xl text-center">
                        🎅 {room.discount}%
                      </p>
                ...
                <div className="relative">
                  ...
                  <div className="relative bg-gradient-to-br from-red-600 to-green-600 text-white px-6 py-4 rounded-2xl shadow-2xl border-4 border-yellow-400">
                    <p className="text-sm font-semibold opacity-90 text-center">
                      🎁 From
                    </p>
              ...
              <div className="bg-white/95 backdrop-blur-sm p-4 rounded-3xl shadow-2xl border-4 border-green-300">
                ...
                <div className="grid grid-cols-5 gap-2">
                  {room.images.slice(0, 5).map((image, index) => (
                    ...
                    >
                      <img
                        className={`w-full h-20 rounded-lg object-cover border-3 transition-all duration-300 group-hover:scale-105 ${
                          mainImage === image
                            ? "border-yellow-400 shadow-yellow-400/50 shadow-lg"
                            : "border-green-300 hover:border-red-300"
                        }`}
                        src={image}
                        alt="Room Image"
                      />
          ...
          <div className="bg-gradient-to-br from-white via-red-50 to-green-50 p-6 rounded-3xl shadow-2xl border-4 border-red-200 mb-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
              {room.amenities.map((item, index) => (
                <div
                  key={index}
                  className="flex items-center gap-2 px-4 py-3 rounded-xl bg-gradient-to-r from-red-100 to-green-100 shadow-md border-2 border-red-200 hover:shadow-xl hover:scale-105 transition-all cursor-pointer"
                >
                  <img
            ...
            <div className="space-y-3">
              {roomCommonData.slice(0, 3).map((spec, index) => (
                <div
                  key={index}
                  className="flex items-start gap-3 p-4 rounded-xl hover:bg-gradient-to-r hover:from-red-50 hover:to-green-50 transition-all border-2 border-transparent hover:border-red-200 cursor-pointer"
                >
                  ...
                  <div className="flex justify-center mt-2">
                    {[...Array(5)].map((_, i) => (
                      <span
                        key={i}
                        className={`text-lg ${
                          i < Math.round(avgRatings.overall)
                            ? "text-yellow-500"
                            : "text-gray-300"
                        }`}
                      >
                  ...
                  <div className="flex justify-center mt-2">
                    {[...Array(5)].map((_, i) => (
                      <span
                        key={i}
                        className={`text-lg ${
                          i < Math.round(avgRatings.service)
                            ? "text-green-500"
                            : "text-gray-300"
                        }`}
                      >
                  ...
                  <div className="flex justify-center mt-2">
                    {[...Array(5)].map((_, i) => (
                      <span
                        key={i}
                        className={`text-lg ${
                          i < Math.round(avgRatings.cleanliness)
                            ? "text-blue-500"
                            : "text-gray-300"
                        }`}
                      >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {displayedReviews.map((review) => {
                  ...
                  return (
                    <div
                      key={review._id}
                      className="bg-white p-5 rounded-2xl border-3 border-red-200 shadow-lg hover:shadow-2xl hover:scale-105 transition-all cursor-pointer relative"
                    >
                      {isMyReview && (
          ...
          <div className="bg-gradient-to-br from-red-50 via-white to-green-50 border-4 border-red-200 p-6 rounded-3xl shadow-xl mb-6">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              availability. You get a comfortable two bedroom apartment that has
              a true city feeling. The price quoted is for two guests; at the
              guest slot, please mark the number of guests to get the exact
              price for groups. Experience comfort and luxury in this
          ...
          <div className="bg-gradient-to-br from-white to-green-50 p-6 rounded-3xl shadow-2xl border-4 border-green-300">
            <div className="flex flex-col md:flex-row md:items-center gap-6">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-3 mb-3">
                  <StarRating rating={avgRatings ? avgRatings.overall : 0} />
                ...
                <button
                  ...
                  className="px-6 py-2 rounded-xl text-white bg-gradient-to-r from-red-600 to-green-600 hover:from-red-700 hover:to-green-700 transition-all shadow-lg hover:shadow-xl font-bold border-2 border-yellow-400 hover:scale-105"
                >
                  📞 Contact Host
                </button>
              </div>

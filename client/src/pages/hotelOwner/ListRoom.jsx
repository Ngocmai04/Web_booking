...
const ListRoom = () => {
    ...
    const onSubmitAddRoom = async (e) => {
        e.preventDefault()
        if (!addRoomInputs.roomType || !addRoomInputs.pricePerNight || !selectedHotelId) {
        ...
        try {
            ...
            const amenities = Object.keys(addRoomInputs.amenities).filter(key => addRoomInputs.amenities[key])
    ...
    return (
        <div>
            ...
            <div className="mb-8 relative">
                <div className="absolute -top-2 -left-2 text-6xl opacity-20 animate-bounce">🛏️</div>
                <div className="flex justify-between items-start">
                    <div>
                        ...
                        <p className="text-gray-700 font-semibold text-lg leading-relaxed">
                            View, edit, or manage all listed rooms. Add new rooms to expand your offerings.
                        </p>
                    </div>
                    <button
            ...
            {showAddRoomForm && (
                <div className="mb-8 bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 border-4 border-green-400 rounded-3xl p-6 shadow-2xl">
                    <h2 className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-blue-600 mb-6 flex items-center gap-3">
                        🏨 Add New Room
                    </h2>
                    ...
                    <form onSubmit={onSubmitAddRoom}>
                                    ...
                                    >
                                        <div className="relative overflow-hidden rounded-xl border-3 border-blue-300 hover:border-purple-400 transition-all duration-300 shadow-md hover:shadow-lg">
                                            ...
                                            <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                                <span className="text-white text-sm font-bold">Click to upload</span>
                                            </div>
                                        </div>
                                        <input 
                                            type="file" 
                        ...
                        <div className='flex items-center gap-4'>
                            <button 
                                type="submit"
                                className='bg-gradient-to-r from-green-600 to-blue-600 text-white font-bold px-8 py-3 rounded-xl cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed shadow-lg hover:shadow-xl hover:scale-105 transition-all border-3 border-green-400' 
                            ...
                            {!hotelsAvailable && (
                                <div className="bg-red-100 border-2 border-red-400 rounded-lg px-4 py-2">
                                    <p className='text-sm text-red-700 font-bold'>Please register a hotel first.</p>
                                </div>
                            )}
                        </div>
                    </form>
                    ...
                    <div className="overflow-x-auto max-h-96 overflow-y-auto custom-scrollbar">
                        <table className='w-full'>
                            <thead className='bg-gradient-to-r from-blue-500 via-purple-500 to-blue-500 text-white sticky top-0 z-10'>
                                <tr>
                                    <th className='py-4 px-6 font-black text-left text-lg'>🛏️ Room Type</th>
                                    <th className='py-4 px-6 font-black text-left text-lg max-sm:hidden'>✨ Amenities</th>
                                    <th className='py-4 px-6 font-black text-center text-lg'>💵 Price/Night</th>
                                    <th className='py-4 px-6 font-black text-center text-lg'>🔄 Availability</th>
                                </tr>
                            </thead>
                                    ...
                                    <tr>
                                        <td colSpan="4" className="py-16 text-center">
                                            <div className="flex flex-col items-center gap-4">
                                                ...
                                                <p className="text-gray-400 text-sm">Click "Add New Room" above to add your first room 🎄</p>
                                            </div>
                                        </td>
                                    </tr>
                                ) : (
                                            ...
                                            <td className='py-4 px-6 text-center'>
                                                <label className="relative inline-flex items-center cursor-pointer group/toggle">
                                                    ...
                                                    <span className={`ml-3 font-bold text-sm ${
                                                        item.isAvailable ? 'text-green-700' : 'text-gray-700'
                                                    }`}>

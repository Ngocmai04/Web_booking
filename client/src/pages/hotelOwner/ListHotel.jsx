    ...
    return (
        <div>
            ...
            <div className="mb-10 relative">
                <div className="absolute -top-2 -left-2 text-6xl opacity-20 animate-bounce">🏨</div>
                <h1 className="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-red-600 via-green-600 to-red-600 mb-3 drop-shadow-lg">
                    🎄 Manage Your Hotels
                </h1>
            ...
            {ownerHotels.length === 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-20 relative">
                    ...
                    <div className="absolute bottom-10 right-1/4 text-6xl opacity-20 animate-bounce" style={{animationDelay: '0.5s'}}>🎁</div>
                    ...
                    <div className="bg-gradient-to-br from-red-100 via-green-100 to-red-100 border-4 border-red-400 rounded-3xl p-12 shadow-2xl text-center max-w-2xl">
                        ...
                        <p className="text-xl text-gray-700 mb-8 font-semibold">
                            Let's add some Christmas magic and create your first hotel! ✨
                        </p>
                        <button
                ...
                <>
                        ...
                        {ownerHotels.map((hotel, index) => (
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    <h3 className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-green-600 mb-4 drop-shadow-lg">
                                        {hotel.name}
                                    </h3>
                                    ...
                                    <div className="space-y-3 mb-6">
                                        <div className="flex items-start gap-2">
                                            ...
                                            <div>
                                                <p className="font-bold text-gray-600 text-xs">Address</p>
                                                <p className="text-gray-800 font-semibold">{hotel.address}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-start gap-2">
                                            <span className="text-xl">🌆</span>
                                            <div>
                                                <p className="font-bold text-gray-600 text-xs">City</p>
                                        ...
                                        <div className="flex items-start gap-2">
                                            <span className="text-xl">📞</span>
                                            <div>
                                                <p className="font-bold text-gray-600 text-xs">Contact</p>
                    ...
                    <div className="flex justify-center pt-8">
                        ...
                        >
                            ...
                            <div className="absolute top-2 left-8 text-yellow-300 animate-ping opacity-0 group-hover:opacity-100">⭐</div>
                            <div className="absolute bottom-2 right-8 text-yellow-300 animate-ping opacity-0 group-hover:opacity-100" style={{animationDelay: '0.2s'}}>⭐</div>
                        </button>
                    </div>
                </>
            )}

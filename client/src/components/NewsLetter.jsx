...
const NewsLetter = () => {
  return (
    ...
    >
      ...
      <MotionDiv className="absolute top-6 left-6 text-4xl opacity-20" variants={item}>
        🎄
      </MotionDiv>
      <MotionDiv className="absolute bottom-6 right-6 text-4xl opacity-20" variants={item}>
        ❄️
      </MotionDiv>
      <MotionDiv className="absolute top-1/2 left-1/4 text-3xl opacity-10" variants={item}>
        ⭐
      </MotionDiv>
      <MotionDiv className="absolute top-1/3 right-1/4 text-3xl opacity-10" variants={item}>
        🎁
      </MotionDiv>
      ...
      <MotionDiv
        ...
        viewport={{ once: true }}
      >
        <MotionDiv className="text-4xl mb-4" variants={item}>
          🎅
        </MotionDiv>

        {/* Title */}
        <MotionDiv className="text-center mb-8" variants={item}>

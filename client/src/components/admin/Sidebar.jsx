  ...
  return (
    <div className="w-64 h-full bg-gradient-to-b from-red-700 via-red-800 to-green-800 shadow-2xl relative overflow-hidden border-r-4 border-yellow-400">
      ...
      <div className="absolute inset-0 opacity-20 pointer-events-none">
        <div className="absolute top-10 left-4 text-white text-lg animate-snow-fall">
          ❄
        </div>
        <div className="absolute top-20 right-6 text-white text-sm animate-snow-fall-delayed">
          ❄
        </div>
        <div className="absolute top-40 left-8 text-white text-base animate-snow-fall-slow">
          ❄
        </div>
        <div className="absolute top-64 right-4 text-white text-lg animate-snow-fall">
          ❄
        </div>
        <div className="absolute bottom-32 left-6 text-white text-base animate-snow-fall-delayed">
          ❄
        </div>
        <div className="absolute bottom-16 right-8 text-white text-sm animate-snow-fall-slow">
          ❄
        </div>
      </div>
      ...
      <div className="p-6 relative z-10 h-full overflow-y-auto">
        ...
        <div className="mb-6 text-center">
          <svg
            className="w-16 h-16 mx-auto mb-2 text-yellow-300 hover:scale-110 transform transition-all duration-300 cursor-pointer animate-pulse-slow"
            fill="currentColor"
            viewBox="0 0 20 20"
          >
            ...
            >
              ...
              <i
                className={`fas ${item.hoverIcon} ml-auto opacity-0 group-hover:opacity-100 transition-all duration-300 relative z-10
                             group-hover:rotate-12 text-lg text-yellow-300`}
              ></i>
            </NavLink>
          ))}
        </nav>
        ...
        <div
          className="p-4 bg-white/10 backdrop-blur-sm rounded-xl border-2 border-white/20 
        ...
        >
          <div className="flex justify-center mb-2">
            <svg
              className="w-10 h-10 text-red-400 group-hover:scale-110 transition-transform"
              fill="currentColor"
              viewBox="0 0 20 20"
            >
        ...
        {/* Stats Mini Card */}
        <div
          className="mt-4 p-4 bg-gradient-to-r from-green-600/50 to-red-600/50 backdrop-blur-sm rounded-xl border-2 border-white/30
        ...
        >
          <div className="flex items-center justify-between mb-2">
            ...
            <svg
              className="w-8 h-8 text-yellow-300 group-hover:rotate-12 transition-transform"
              fill="currentColor"
              viewBox="0 0 20 20"
            >
              <path
          ...
          <div className="text-3xl font-bold text-yellow-300 text-center group-hover:scale-110 transition-transform flex items-center justify-center gap-2">
            ...
            {Math.ceil(
              (new Date("2025-12-25") - new Date()) / (1000 * 60 * 60 * 24)
            )}
          </div>
        </div>
      </div>
